...
let client_id = "PR1PESAZJZCLGFR2MSO0EMAAE0MYLBPT3FE14BWJNMWPKQV0" // visit developer.foursqure.com for API key
let client_secret = "UCFRIV02AVEWV3GIMIO3F0IOX1LQHORAW5NCYWVQBXBBRBLA" // visit developer.foursqure.com for API key
...
//        searchForCoffee()
    ...
    func snapToPlace() {
        let url = "https://api.foursquare.com/v2/venues/search?ll=\(currentLocation.latitude),\(currentLocation.longitude)&v=20160606&intent=checkin&limit=1&radius=4000&client_id=\(client_id)&client_secret=\(client_secret)"
